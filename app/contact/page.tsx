            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm sm:text-base break-all w-96 overflow-wrap break-words">
                    tippehalligrampanchayat@gmail.com
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 mt-8">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="w-full aspect-[3/2] bg-gray-200 relative overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7627.034553667226!2d75.177802!3d17.096249!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc6c7eb2c143f1f%3A0x500b816ffa03c140!2sTippehalli%2C%20Maharashtra%20416404%2C%20India!5e0!3m2!1sen!2sus!4v1760815563579!5m2!1sen!2sus"
                width="1200"
                height="800"
                loading="lazy"
              ></iframe>
